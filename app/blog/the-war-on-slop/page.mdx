...
**Big Takeaway:** When customers ask for more context window, it might be a helpful exercise to look at how we can help design a better system where they can compact context to a smaller window. For most models, even when they support large context 1M+, strict instruction following startups to degrade after ~40k
